...
Do **not** hardcode package versions in long-lived docs. Prefer the unpinned install or pin to the **current** release shown by the PyPI badge / [project page](https://pypi.org/project/xgic-gitlab-graphql/).
